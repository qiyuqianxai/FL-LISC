...
def KDHT(stu_model, mentor_model, mentor_model_name, train_dataloader, test_dataloader, cfg, client_snr = None, client_id=0, com_round=0):
    start = time.time()
    ...
    # testing
    test_mentor_loss, test_stu_loss, test_mentor_acc, test_stu_acc = Test_KDHT_ISC(stu_model, mentor_model, test_dataloader, cfg, client_id, com_round)
